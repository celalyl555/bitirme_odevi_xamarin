...
{
    public class sterlin : ContentPage
    {
        public sterlin()
        {
            Title = "STERLİN";
            ...
            string sterlin_satis = xmldoc.SelectSingleNode("Tarih_Date/Currency[@Kod='GBP']/BanknoteBuying").InnerXml;
            string sterlin_alis = xmldoc.SelectSingleNode("Tarih_Date/Currency[@Kod='GBP']/BanknoteSelling").InnerXml;
            Content = new StackLayout
            {
                BackgroundColor = Color.SkyBlue,//arka plan resmi ayarlanıyor
                Children = {
                    new Label {
                        Text = "STERLİN ALIŞ FİYATI : "+ sterlin_alis + "\nSTERLİN SATIŞ FİYATI : "+ sterlin_satis, //ekrana çekilen fiyatlar yazdırılıyor
